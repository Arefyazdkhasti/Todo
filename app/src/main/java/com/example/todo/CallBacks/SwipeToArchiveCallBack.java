...
abstract public class SwipeToArchiveCallBack extends ItemTouchHelper.Callback {
    ...
    public SwipeToArchiveCallBack(Context context) {
        ...
        backgroundColor = ContextCompat.getColor(context, R.color.swipe_to_archive_color);
        mClearPaint = new Paint();
        mClearPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
        deleteDrawable = ContextCompat.getDrawable(mContext, R.drawable.archive);
